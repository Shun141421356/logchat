...
import { Hash, Archive, Plus, ChevronDown, ChevronRight, LogOut, Trash2, X } from "lucide-react";
...
export function Sidebar({
  ...
  const handleSelectChannel = (channelId: string) => {
    ...
    onClose(); // モバイルではチャンネル選択時にサイドバーを閉じる
  };
    ...
    <>
      ...
      >
        ...
        <div className="px-4 py-[14px] border-b border-white/[0.06] flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-md bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center shadow-sm flex-shrink-0">
